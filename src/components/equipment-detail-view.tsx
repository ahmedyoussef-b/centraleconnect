...
export function EquipmentDetailView({ node, parameters, alarms, logEntries, documents }: EquipmentDetailViewProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            <MaintenancePredictionWidget equipmentId={node.externalId} />
